 ...
 */
var PrettyJson = function (_React$Component) {
    (0, _inherits3.default)(PrettyJson, _React$Component);
    ...
    (0, _createClass3.default)(PrettyJson, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                json = _props.json,
                props = (0, _objectWithoutProperties3.default)(_props, ['className', 'json']);

            var html = this.prettyPrint(json);
